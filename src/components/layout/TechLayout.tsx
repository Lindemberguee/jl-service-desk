...
export function TechLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="h-14 border-b border-border/50 bg-card/80 backdrop-blur-xl flex items-center px-4 gap-3 shrink-0 sticky top-0 z-40">
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate('/tech')}>
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[10px] text-muted-foreground font-medium">Painel Técnico</p>
          </div>
        </div>
        ...
        {memberships.length > 1 && (
          <div className="flex items-center gap-1.5">
            ...
            <Select value={currentTenantId || ''} onValueChange={switchTenant}>
              <SelectTrigger className="w-[140px] h-8 text-xs border-border/50 bg-background/50">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Avatar className="h-8 w-8 ring-2 ring-primary/20 cursor-pointer" onClick={() => navigate('/tech/perfil')}>
      ...
      <main className="flex-1 pb-24 md:pb-6 max-w-5xl mx-auto w-full">
