...
serve(async (req) => {
  ...
  try {
    ...
    const { type, tenant_id, to_email, to_name, subject, html_body, work_order_code, work_order_title, status_label, item_name, current_level, min_level } = body;
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; border-radius: 8px; padding: 20px; border: 1px solid #e2e8f0;">
            <p style="color: #334155; margin: 0;">Seu servidor SMTP está configurado corretamente e pronto para enviar notificações.</p>
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; border-radius: 8px; padding: 20px; border: 1px solid #e2e8f0;">
            ...
            <p style="color: #64748b; margin: 0;">Uma nova OS foi criada/atribuída a você. Acesse o sistema para mais detalhes.</p>
          </div>
        </div>
      `;
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; border-radius: 8px; padding: 20px; border: 1px solid #e2e8f0;">
            ...
            <p style="color: #64748b; margin: 0;">Acesse o sistema para mais detalhes.</p>
          </div>
        </div>
      `;
      ...
      emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; border-radius: 8px; padding: 20px; border: 1px solid #e2e8f0;">
            ...
            <p style="color: #334155; margin: 0 0 8px;"><strong>Nível atual:</strong> ${current_level} / Mínimo: ${min_level}</p>
            <p style="color: #64748b; margin: 0;">Providencie a reposição deste item o mais rápido possível.</p>
          </div>
        </div>
      `;
    }
