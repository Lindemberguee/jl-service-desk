...
import { Hammer, Plus, Trash2, Edit3, LayoutGrid, Loader2 } from 'lucide-react';
...
export default function Ferramentas() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-lg font-semibold">Ferramentas — Canvas</h1>
        <p className="text-xs text-muted-foreground">Crie quadros visuais com nós e conexões, como um mapa mental.</p>
      </div>
