      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Guia de Serviço — {workOrders.length} OS
          </DialogTitle>
        </DialogHeader>

        {/* Preview (hidden during normal view, used for print content) */}
            ...
            <div key={wo.id} className="page">
              ...
              <div className="grid">
                ...
                <div className="field">
                  ...
                  <div className="field-value">{statusLabels[wo.status] || wo.status}</div>
                </div>
                <div className="field">
                ...
                <div className="field">
                  <div className="field-label">SLA Resolução</div>
                  <div className="field-value">{wo.resolve_due_at ? new Date(wo.resolve_due_at).toLocaleString('pt-BR') : '—'}</div>
                </div>
              </div>
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto">
          {workOrders.map((wo: any) => (
            <div key={wo.id} className="border border-border/50 rounded-lg p-3 text-sm">
